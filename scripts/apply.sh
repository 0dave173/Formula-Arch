...
# GTK: copy CSS + button SVGs into GTK dirs
...
cp -f "${repoRoot}/assets/icons/window-buttons/"*.svg   "${HOME}/.config/gtk-3.0/window-buttons/"
cp -f "${repoRoot}/assets/icons/window-buttons/"*.svg   "${HOME}/.config/gtk-4.0/window-buttons/"

# Copy helper scripts
cp -f "${repoRoot}/scripts/set-wallpaper.sh"   "${HOME}/.local/share/formula-arch/bin/set-wallpaper.sh"
chmod +x "${HOME}/.local/share/formula-arch/bin/set-wallpaper.sh"

cp -f "${repoRoot}/scripts/ai/racecontrol.sh"   "${HOME}/.local/share/formula-arch/bin/racecontrol.sh"
